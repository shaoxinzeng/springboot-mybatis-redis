...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).enable(SWAGGER_ENABLE).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.hkd.controller"))
