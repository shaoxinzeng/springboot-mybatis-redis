...
public class AssetBorrowOrder{
    ...
    @ApiModelProperty(value = "借款金额，单位为分")
    private Integer moneyAmount;

    @ApiModelProperty(value = "展示给用户还款金额，单位为分")
    private Integer moneyAmountShow;
    ...
    @ApiModelProperty(value = "放款审核时间")
    private Date verifyLoanTime;

    @ApiModelProperty(value = "放款审核备注")
    private String verifyLoanRemark;

    @ApiModelProperty(value = "放款审核用户")
    private String verifyLoanUser;

    @ApiModelProperty(value = "所属资方,1口袋,2...")
    private Integer capitalType;

    @ApiModelProperty(value = "原因备注")
    private String reasonRemark;

    @ApiModelProperty(value = "信用评级",notes = "信用评级,0:未知,1:A,2:B,3:C,...")
    private Integer creditLv;

    @ApiModelProperty(value = "是否命中风险策略")
    private Byte isHitRiskRule;

    @ApiModelProperty(value = "自动风控检测状态",notes = "自动风控检测状态:-1失败，0未检测，1已检测")
    private Byte autoRiskCheckStatus;

    @ApiModelProperty(value = "是否是老用户",notes = "是否是老用户：0、新用户；1；老用户")
    private Integer customerType;

    @ApiModelProperty(value = "招行订单号")
    private String yurref;

    @ApiModelProperty(value = "招行流水号")
    ...
    @ApiModelProperty(value = "对应银行是否招行",notes = "对应银行是否是招行；1：是；2：否")
    private Integer bankIscmb;

    @ApiModelProperty(value = "状态",notes = "状态：0:待初审(待机审);-3:初审驳回;1:初审通过;-4:复审驳回;20:复审通过,待放款;-5:放款驳回;" +
    ...
    @ApiModelProperty(value = "付款状态",notes = "付款状态： 0：初始状态，1：成功请求到银行，2：请求失败，3：请求成功等待结果；4放款成功")
    ...
    public void setVerifyReviewTime(String verifyReviewTime) {
        this.verifyReviewTime = verifyReviewTime == null ? null : verifyReviewTime.trim();
    }
    ...
    public Integer getMoneyAmountShow() {
        return moneyAmountShow;
    }

    public void setMoneyAmountShow(Integer moneyAmountShow) {
        this.moneyAmountShow = moneyAmountShow;
    }
    ...
    public String toString() {
        return "AssetBorrowOrder{" +
                ...
                ", verifyTrialTime=" + verifyTrialTime +
                ", verifyTrialRemark='" + verifyTrialRemark + '\'' +
                ", verifyTrialUser='" + verifyTrialUser + '\'' +
                ", verifyReviewTime='" + verifyReviewTime + '\'' +
                ", verifyReviewRemark='" + verifyReviewRemark + '\'' +
                ", verifyReviewUser='" + verifyReviewUser + '\'' +
                ", verifyLoanTime=" + verifyLoanTime +
                ", verifyLoanRemark='" + verifyLoanRemark + '\'' +
                ", verifyLoanUser='" + verifyLoanUser + '\'' +
                ", capitalType=" + capitalType +
                ", reasonRemark='" + reasonRemark + '\'' +
                ", creditLv=" + creditLv +
                ", isHitRiskRule=" + isHitRiskRule +
                ", autoRiskCheckStatus=" + autoRiskCheckStatus +
